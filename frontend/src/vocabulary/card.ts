 ...
 *
 * До цього кожен приклад був парою полів із власним «прибрати», і другий
 * приклад починався з натискання кнопки. Тепер другий приклад починається з
 * Enter, тобто рукою, яка вже на клавіатурі.
 *
 * Ціна відома й прийнята: довгий приклад переноситься, і його хвіст на око не
 * відрізнити від наступного рядка. Альтернатива — горизонтальна прокрутка,
 * тобто набране ховається вбік просто під час набору (ADR-0033).
 */
