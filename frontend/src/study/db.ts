...
export type BufferRecord = {
   ...
   *
   * Необовʼязкове саме тому, що воно зʼявилось пізніше: у базах на телефонах
   * лежать записи без нього, а сховище тут безсхемне, тож версію бази піднімати
   * не треба. Читач підставляє 0, і перша ж вибірка це виправляє.
   */
