  ...
  plugins: [
    ...
    VitePWA({
      ...
      manifest: {
        ...
        // index.html, і одне значення на обидві теми давало чорну смугу над
        // світлою. Без поля вона йде за системною темою. `undefined`, а не
        // пропуск: плагін інакше підставляє власний зелений дефолт.
