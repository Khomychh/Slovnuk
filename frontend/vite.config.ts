  ...
  plugins: [
    ...
    VitePWA({
      ...
      manifest: {
        ...
        // index.html. Поле одне на обидві теми, тож тут світлий --night: у
        // темному режимі Chrome колір сторінки ігнорує і малює свій чорний,
        // близький до темного --night, а у світлому — бере це значення.
        theme_color: "#eef1fa",
